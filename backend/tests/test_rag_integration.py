    ...
    def test_query_with_empty_vector_store_still_responds(self, mock_config):
        ...
        with (
            ...
            mock_ai.generate_response.return_value = (
                "I couldn't find any relevant course content."
            )
...
class TestRAGSystemQueryWithPopulatedStore:
    ...
    def test_query_triggers_search_and_returns_response(
        self, mock_config, sample_search_results
    ):
    ...
    def test_query_returns_sources_from_search(
        self, mock_config, sample_search_results
    ):
...
class TestRAGSystemDocumentProcessing:
    ...
    def test_add_course_document_processes_and_stores(
    ...
    def test_add_course_folder_processes_multiple_files(
        self, mock_config, sample_course, sample_course_chunks
    ):
